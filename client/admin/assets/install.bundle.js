...
var render = function() {
  ...
  return _c(
    "div",
    { staticClass: "font-sans flex flex-col flex-grow", attrs: { id: "app" } },
    [
          ...
          [
            _c("div", { staticClass: "mb-4" }, [
              _c(
                ...
                {
                  staticClass:
                    "border py-2 rounded text-pink-dark list-reset border-pink-dark px-3 text-sm"
                },
  ...
  function() {
    ...
    return _c("div", { staticClass: "flex items-center justify-between" }, [
      _c(
        ...
        {
          staticClass:
            "bg-indigo hover:bg-indigo-dark text-white py-2 px-4 rounded focus:outline-none focus:shadow-outline",
          attrs: { type: "submit" }
        },
        [_vm._v("\n          Submit\n        ")]
      )
